...
#endif
#define BOOST_KERNELALLOC_V1 (boost), (kernelalloc), (BOOST_BINDLIB_NAMESPACE_VERSION(v1, BOOST_KERNELALLOC_V1_STL11_IMPL, BOOST_KERNELALLOC_V1_FILESYSTEM_IMPL), inline)
